   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" required placeholder="enter your contact No">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="flat" required placeholder="e.g. flat no./home no">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="e.g. sammanthurai">
         </div>
         <div class="inputBox">
            <span>District :</span>
            <input type="text" name="state" required placeholder="e.g. Ampara">
         </div>
         <div class="inputBox">
            <span>country :</span>
